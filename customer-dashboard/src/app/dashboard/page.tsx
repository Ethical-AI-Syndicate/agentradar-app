    ...
    <DashboardLayout>
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 text-lg">
                Your real estate intelligence dashboard is ready.
              </p>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      <h3 className="font-medium text-gray-900">Power of Sale - Vaughan</h3>
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                        High Priority
                      </span>
                    </div>
                    <p className="text-sm text-gray-500 mt-1">
                      123 Main Street, Vaughan - 3BR/2BA - Estimated Value: $850,000
                    </p>
                    <div className="flex items-center space-x-4 mt-2 text-xs text-gray-400">
                      <span>2 hours ago</span>
                      <span>Opportunity Score: 85</span>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <button className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow group">
            <div className="text-center">
              ...
              <h3 className="font-medium text-gray-900 mb-1">Search Properties</h3>
          ...
          <button className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow group">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500">Customize alerts</p>
            </div>
          </button>

          <button className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow group">
            <div className="text-center">
              <div className="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-orange-100 transition-colors">
