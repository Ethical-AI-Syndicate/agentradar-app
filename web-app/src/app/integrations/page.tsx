...
import { CheckCircle, ArrowRight, Zap, Database, Cloud, Code } from "lucide-react"
import Image from "next/image"

export const metadata: Metadata = {
  title: "Integrations | AgentRadar",
  description: "Connect AgentRadar with your favorite CRM, MLS, and real estate tools",
}
...
export default function IntegrationsPage() {
  const integrationCategories = [
    {
      ...
      integrations: [
        { name: "Salesforce", logo: "/logos/salesforce.svg", status: "Available" },
        { name: "HubSpot", logo: "/logos/hubspot.svg", status: "Available" },
        { name: "Pipedrive", logo: "/logos/pipedrive.svg", status: "Available" },
        { name: "Zoho CRM", logo: "/logos/zoho.svg", status: "Coming Soon" },
        { name: "Microsoft Dynamics", logo: "/logos/dynamics.svg", status: "Coming Soon" }
      ]
    },
    {
      title: "MLS Platforms", 
    ...
    },
    {
      ...
      integrations: [
        ...
        { name: "Top Producer", logo: "/logos/topproducer.svg", status: "Coming Soon" },
        { name: "Real Geeks", logo: "/logos/realgeeks.svg", status: "Coming Soon" }
      ]
    },
    {
      title: "Communication",
      ...
      integrations: [
        ...
        { name: "Microsoft Teams", logo: "/logos/teams.svg", status: "Available" },
        { name: "WhatsApp Business", logo: "/logos/whatsapp.svg", status: "Available" },
        { name: "SMS Platforms", logo: "/logos/sms.svg", status: "Available" },
        { name: "Email Marketing", logo: "/logos/email.svg", status: "Available" }
      ]
    }
  ]
  ...
  const apiFeatures = [
    ...
    },
    {
      icon: Cloud,
      title: "Webhooks",
      description: "Real-time notifications for property alerts and status changes"
    },
    {
      icon: Code,
      title: "Custom Integrations",
      description: "Work with our team to build custom integrations for your specific needs"
    },
    {
      icon: Zap,
      ...
      <section className="pt-16 pb-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Seamlessly integrate with your existing CRM, MLS, and real estate tools. 
            Automate workflows and centralize your property intelligence.
          </p>
                    ...
                    <CardContent className="p-6">
                      ...
                      <Badge 
                        variant={integration.status === "Available" ? "default" : 
                                integration.status === "Coming Soon" ? "secondary" : "outline"}
                        className="text-xs"
                      >
                        {integration.status}
                      </Badge>
