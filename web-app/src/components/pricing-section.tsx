      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              All plans include our core intelligence sources. Choose based on your team size and advanced feature needs.
            </p>
            ...
            <div className="inline-flex items-center gap-4 p-2 bg-white rounded-lg border border-orange-200 shadow-sm">
              <span className="text-sm font-medium text-gray-700">Regular Pricing</span>
              <button
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      ...
                      <ul className="space-y-1">
                        {plan.limitations.map((limitation, limitationIndex) => (
                          <li key={limitationIndex} className="text-xs text-gray-500">
                            • {limitation}
                          </li>
                        ))}
                      </ul>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <h3 className="text-3xl font-bold mb-4">Enterprise & Brokerage Solutions</h3>
            <p className="text-xl text-indigo-100 mb-8">
              Deploy AgentRadar as your own white-labeled platform for your entire brokerage. 
              Custom branding, dedicated infrastructure, and enterprise-grade security.
            </p>
        ...
        >
          <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-6 py-3">
            ...
            <div className="text-left">
              <div className="font-semibold text-green-900">30-Day Money-Back Guarantee</div>
              <div className="text-sm text-green-700">Try AgentRadar risk-free. Cancel anytime in the first 30 days for a full refund.</div>
            </div>
          </div>

          <p className="text-gray-600 mt-6 text-sm">
            All plans include access to our core intelligence sources. No setup fees. Cancel anytime.
          </p>
        </motion.div>
      </div>
    </section>
