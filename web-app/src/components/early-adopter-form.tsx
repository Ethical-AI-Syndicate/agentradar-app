          ...
          <div className="bg-gradient-to-br from-green-500 to-emerald-600 p-8 text-white text-center">
            ...
            >
              ...
              <p className="text-green-100 text-lg mb-6">
                You&apos;re now part of an exclusive group of forward-thinking
            ...
            >
              ...
              <div className="space-y-3 text-left text-green-100">
                <div className="flex items-center space-x-3">
                  ...
                  <span>
                    We&apos;ll email you your early adopter token within 24
                    hours
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <span>
                    You&apos;ll get exclusive updates on our launch progress
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                  ...
                  <span>
                    First access to AgentRadar when we go live (with 50%
                    lifetime discount!)
                  </span>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-orange-600 p-6 text-white">
          <DialogHeader>
            ...
            <p className="text-blue-100 mt-2">
              Join the exclusive group of agents building tomorrow&apos;s
              pipelines today
            </p>
          </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("brokerageName", e.target.value)
                    }
            ...
            >
                    ...
                    {["0-2 years", "3-5 years", "6-10 years", "10+ years"].map(
                      (years) => (
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            updateFormData("yearsExperience", years)
                          }
                          className="text-xs"
                        >
                          {years}
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    {["0-5", "6-15", "16-30", "30+"].map((listings) => (
                      <Button
                        key={listings}
                        variant={
                          formData.currentListings === listings
                            ? "default"
                            : "outline"
                        }
                        size="sm"
                        onClick={() =>
                          updateFormData("currentListings", listings)
                        }
                        className="text-xs"
                      >
                        {listings}
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  {["Under $500K", "$500K-$1M", "$1M-$2M", "$2M+"].map(
                    (price) => (
                      <Button
                        key={price}
                        variant={
                          formData.averageListingPrice === price
                            ? "default"
                            : "outline"
                        }
                        size="sm"
                        onClick={() =>
                          updateFormData("averageListingPrice", price)
                        }
                        className="text-xs"
                      >
                        {price}
              ...
              <div>
                <Label>
                  Current Prospecting Challenges (Select All That Apply)
                </Label>
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {["Email", "Phone", "Text/SMS", "Any"].map((comm) => (
                    <Button
                      key={comm}
                      variant={
                        formData.preferredCommunication === comm
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                      onClick={() =>
                        updateFormData("preferredCommunication", comm)
                      }
                      className="text-sm"
                    >
                      {comm}
              ...
              <div className="bg-gray-50 border rounded-lg p-4">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <p className="text-xs text-gray-600">
                    I agree to receive email communications from AgentRadar
                    about our platform launch and real estate intelligence
                    insights. We respect your privacy and will never share your
                    information with third parties. You can unsubscribe at any
                    time. *
                  </p>
                </label>
              </div>
                ...
                disabled={
                  ...
                  (step === 2 &&
                    (!formData.yearsExperience ||
                      !formData.currentListings ||
                      !formData.averageListingPrice ||
