  ...
  const steps = [
    {
      ...
      description:
        "Our AI continuously monitors court filings, estate sales, and municipal applications across Ontario",
      details: [
    ...
    },
    {
      ...
      title: "Smart Scoring",
      description:
        "Every opportunity gets an AI-powered score based on timeline, property value, and market conditions",
      details: [
    ...
    },
    {
      ...
      description:
        "Get notified immediately when high-score opportunities match your criteria and geographic focus",
      details: [
    ...
    },
    {
      ...
      description:
        "Connect with property owners months before they need to sell, building trust and positioning yourself as the obvious choice",
      details: [
  ...
  const sources = [
    {
      ...
      description:
        "Monitor Ontario Superior Court bulletins for power of sale listings 6-12 months before they hit MLS",
    ...
    },
    {
      ...
      description:
        "Track probate filings and estate sales that often result in motivated sellers and below-market opportunities",
    ...
    },
    {
      ...
      description:
        "Identify development applications that signal upcoming construction, rezoning, or property improvements",
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              While other agents react to MLS listings, you&apos;ll be building
              relationships with sellers 6-12 months before they even think
              about listing their property.
            </p>
          </motion.div>
        </div>
                ...
                <div className="flex-1">
                  <Card className="p-8 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100 shadow-lg">
                    <div className="text-center">
                      <div
                        className={`inline-flex p-4 rounded-full bg-gradient-to-r ${step.color} mb-4`}
                      >
                      ...
                      <p className="text-gray-600 text-sm">
                        {step.title === "Intelligent Discovery" &&
                          "Monitor 24/7 across multiple data sources"}
                        {step.title === "Smart Scoring" &&
                          "AI analyzes and ranks every opportunity"}
                        {step.title === "Instant Alerts" &&
                          "Get notified immediately via your preferred method"}
                        {step.title === "Early Relationship Building" &&
                          "Connect months before the competition knows"}
                      </p>
                    </div>
                  </Card>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <div className="text-gray-700">
                More Lead Time Than Competitors
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-gray-700">
                Competition When You Call First
              </div>
            </div>
          </div>

          <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
            Imagine calling a property owner who&apos;s dealing with a power of
            sale proceeding, and you&apos;re the{" "}
            <strong>first and only agent</strong> who knows about their
            situation. That&apos;s the power of intelligence-driven prospecting.
          </p>
