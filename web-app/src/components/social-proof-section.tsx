...
export function SocialProofSection() {
  const testimonials = [
    {
      quote:
        "AgentRadar gave us a 6-month head start on a $2.8M power of sale listing. We built a relationship with the owners before any other agent even knew about it. Game changer.",
      name: "Maria Santos",
    ...
    {
      quote:
        "The estate sale alerts alone have generated over $180K in commissions. These opportunities never make it to MLS, so there's zero competition.",
    ...
    {
      quote:
        "Our brokerage deployed the white-label version for our 200+ agents. The intelligence advantage has increased our market share by 23% in just 6 months.",
      name: "Jennifer Walsh",
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Join over 1,200 forward-thinking real estate professionals who are
              already building their competitive advantage with AgentRadar.
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-gray-600">
              Join the growing community of successful agents using
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              <div className="flex -space-x-2">
                {[...Array(8)].map((_, i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-orange-400 border-2 border-white"
                  />
                ))}
              </div>
