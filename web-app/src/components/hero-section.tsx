      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Discover properties <strong className="text-orange-400">6-12 months before MLS</strong> through court filings, estate sales, and development applications. Build your pipeline with exclusive intelligence.
            </motion.p>
          ...
          >
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-white">Property Intelligence Dashboard</h3>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-300">{property.type} • {property.timeline}</p>
                        <p className="text-xs text-gray-400">{property.status}</p>
                      </div>
                      <div className="text-right">
                        <div className="flex items-center space-x-1">
                          <span className="text-orange-400 font-bold">{property.score}</span>
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-300">Total Opportunities This Week</span>
                  <span className="text-orange-400 font-bold">47 Properties</span>
                </div>
              </div>
            </Card>
